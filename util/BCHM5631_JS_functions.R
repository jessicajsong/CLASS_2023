# FUN: multiply two number
# @description
# A function to multiply two numbers
# @param
# x one number you'd like to multiply
...
# IMPORT PEAKS: get consensus peak file path, select .broadPeak and then get dbp name from file name
# @description
# A function to set the file path to peak files and extracts the DBP name
# First step in loading in ChIP peak files
# @param
