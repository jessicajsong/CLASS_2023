...
setwd("/scratch/Shares/rinnclass/CLASS_2023/jeso3380/CLASS_2023/CLASSES/05_R_analyses/01_peak_features")
...
names(consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2023/jeso3380/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/consensus_peaks|_consensus.bed","", consensus_peaks_files)
...
# gtf is a generalized text file
...
# promoter regions with Genomic Ranges function "promoters"
?promoters
...
# this number is the same as wht we have for lncrna_gene_ids
...
## we'll be using num_peaks_df for plotting
...
```{r count_peaks_per_feature function to find overlaps !}
...
genebody_peak_counts <- count_peaks_per_feature(mrna_lncrna_genes, 
                                                consensus_peaks, 
                                                type = "counts")
## takes some time to load, don't freak out when a white screen loads when you try to open it
...
## $whatever is indexing and creating that column
